...
object PublicActorApi {

  def CreatedTournaments = ActorApi.CreatedTournaments
  def StartedTournaments = ActorApi.StartedTournaments
  def StartPairings = ActorApi.StartPairings
}

private[tournament] object ActorApi {
